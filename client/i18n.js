...
(function () {
    const LANG_STORAGE_KEY = 'onehive_lang';
    ...
    function updateDOM(lang) {
        ...
        const switchers = document.querySelectorAll('.lang-switcher-text, #langSwitcherTrigger');
        switchers.forEach(switcher => {
            switcher.innerText = lang.toUpperCase();
        });
    }
